        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-4 custom-scrollbar">
          {customWindowCards.map((card) => {
            ...
            return (
              ...
              >
                <div className="relative w-full h-full bg-[#1e1b4b] rounded-[calc(2rem-2px)] overflow-hidden flex flex-col md:flex-row">
                  {/* Subtle Glow Effects specific to the card */}
                  <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-l from-transparent to-[#1e1b4b] opacity-50 pointer-events-none z-0"></div>
